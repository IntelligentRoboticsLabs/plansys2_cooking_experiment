...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(cooking_dir, 'params', 'nav2_cooking_tiago_params.yaml'),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(cooking_launch_dir, 'nav2_bringup_launch.py')),
